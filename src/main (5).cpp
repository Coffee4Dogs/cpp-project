...
int main() {
    ...
    if(file.is_open()){
        ...
        // string Nacimiento;       FALTA
        // int DiaNacimiento;       FALTA
        // int MesNacimiento;       FALTA
        // int AñoNacimiento;       FALTA
        // int Edad;    /           /
        // double IMS = -1;         //(Índice de Masa Corporal)
        // double Altura; ********
        // double Peso;    ****************
        // string TipoSangre; **********
        // string Cita;        
        // int DiaCita;     Eliminado
        // int HoraCita;  ********
        // int MinutoCita; ********
        // string Antecedentes;         FALTA
        // string EnfermedadActual;     Expedientes
        // string Direccion;            FALTA
